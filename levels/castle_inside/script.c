...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 23, 100, 1210, 0, -90, 0, (167 << 16), bhvMessagePanel),
		OBJECT(MODEL_TOAD, 399, 100, 1088, 0, 70, 0, (166 << 24), bhvToadMessage),
		OBJECT(MODEL_RED_FLAME, -1895, 174, -1516, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_TOAD, -5977, 1585, 1451, 0, 84, 0, 0x00000000, bhvToad),
		OBJECT(MODEL_TOAD, -1743, 1436, 6161, 0, 167, 0, 0x00000000, bhvToad),
		OBJECT(MODEL_NONE, -356, 200, 1198, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -356, 200, 1198),
		OBJECT(MODEL_BITS_WARP_PIPE, 393, 100, 1386, 0, 0, 0, (0x03 << 16), bhvWarpPipe),
		OBJECT(MODEL_NONE, 392, 365, 1386, 0, 90, 0, (0x11 << 16), bhvPaintingDeathWarp),

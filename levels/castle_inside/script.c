...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_TOAD, 399, 100, 1234, 0, 171, 0, (166 << 24), bhvToadMessage),
		OBJECT(MODEL_RED_FLAME, -929, 174, -857, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_WOODEN_SIGNPOST, 23, 100, 1272, 0, -90, 0, (168 << 16), bhvMessagePanelSpawnPipe),
		...
		OBJECT(MODEL_NONE, -219, 365, 1557, 0, 90, 0, (0x11 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -219, 365, 1557, 0, 90, 0, (0x12 << 16), bhvDeathWarp),

...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		WARP_NODE(0x08, LEVEL_WF, 0x01, 0x08, WARP_CHECKPOINT),
		WARP_NODE(0x09, LEVEL_WF, 0x01, 0x09, WARP_CHECKPOINT),
		...
		OBJECT(MODEL_CHUCKYA, 5127, 2105, -496, 0, 0, 0, 0x00000000, bhvChuckya),
		...
		OBJECT(MODEL_CHUCKYA, 5519, 2105, -683, 0, 0, 0, 0x00000000, bhvChuckya),
		...
		OBJECT(MODEL_NONE, 5536, 889, 638, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 5536, 889, 638),
		OBJECT(MODEL_NONE, 4833, 753, 1, 0, 0, 0, (0x07 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 5374, 713, -509, 0, 0, 0, (0x08 << 16), bhvDeathWarp),
		OBJECT(MODEL_HEART, 5374, 713, -509, 0, 0, 0, (0x09 << 16), bhvDeathWarp),
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_NONE, 0, 86, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 86, 0),

...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 5847, 229, -18, 0, 0, 0, (4 << 16), bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, 6089, 768, -16, 0, 0, 0, (5 << 16), bhvExclamationBox),
		OBJECT(MODEL_YELLOW_COIN, 1637, 68, -26, 0, 90, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_CHUCKYA, 7607, 2105, -592, 0, 0, 0, 0x00000000, bhvChuckya),
		...
		OBJECT(MODEL_NONE, 6460, 2142, 571, 0, -180, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, 7245, 2142, 286, 0, -180, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, 6850, 2142, -661, 0, 0, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, -969, 263, -31, 0, 0, 0, 0x00000000, bhv1kCoinStar),
		OBJECT(MODEL_1UP, 7737, 2212, -37, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_CHUCKYA, 7999, 2105, -602, 0, -37, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_AMP, 8132, 2148, -368, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 8303, 2148, -226, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 8498, 2148, -50, 0, 0, 0, 0x00000000, bhvHomingAmp),
		OBJECT(MODEL_NONE, 8799, 1811, -36, 0, 0, 0, (1 << 16), bhvCoinFormation),

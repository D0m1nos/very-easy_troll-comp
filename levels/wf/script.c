...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, -1042, 483, -4, 0, 0, 0, (6 << 16), bhvExclamationBox),
		OBJECT(MODEL_1UP, 45, 70, -1033, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_NONE, -969, 263, -31, 0, 0, 0, 0x00000000, bhv1kCoinStar),
		...
		OBJECT(MODEL_AMP, 7801, 2148, -982, 0, 0, 0, 0x00000000, bhvHomingAmp),

...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 6550, 2142, -881, 0, 0, 0, 0x00000000, bhvFlamethrower),
	...
	AREA(9, wf_area_9),
		...
		OBJECT(MODEL_NONE, 7931, 2393, -632, 0, 0, 0, 0x00000000, bhvQuicksandTransporter),
		OBJECT(MODEL_NONE, 7310, 805, 18, 0, 0, 0, (0 << 16), bhvChallengeDone),
		OBJECT(MODEL_NONE, 7852, 833, -502, 0, 90, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 90, 7852, 833, -502),
		OBJECT(MODEL_NONE, 7312, 753, 1, 0, 0, 0, (0x07 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 7853, 713, -509, 0, 0, 0, (0x08 << 16), bhvDeathWarp),

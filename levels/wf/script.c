...
const LevelScript level_wf_entry[] = {
	...
	AREA(6, wf_area_6),
		...
		OBJECT(MODEL_AMP, 8642, 2885, 288, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 9398, 2885, 733, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 10193, 2885, 233, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 10657, 2837, 586, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_CHUCKYA, 12129, 5542, 471, 0, 0, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, 17166, 6562, 388, 0, 0, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_WF_ROTATING_PLATFORM, 13843, 5640, 421, 0, 0, 0, (15 << 24), bhvRotatingPlatform),
		OBJECT(MODEL_WF_ROTATING_PLATFORM, 15609, 5932, 421, 0, 0, 0, (20 << 24), bhvActuallyRotatingPlatform),
		OBJECT(MODEL_NONE, 0, 200, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -82205, 0, -41298),
		OBJECT(MODEL_BITS_WARP_PIPE, 17507, 6465, 379, 0, 0, 0, (0xB1 << 16), bhvWarpPipe),

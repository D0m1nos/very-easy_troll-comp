...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 2997, 1285, 76, 0, 0, 0, 0x00000000, bhv1kCoinStar),
		OBJECT(MODEL_1UP, 7983, 2212, -37, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_1UP, 7187, 2212, -37, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_CHUCKYA, 7438, 2121, -297, 0, -37, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, 7607, 2117, 139, 0, 0, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_AMP, 8258, 2148, -268, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 8555, 2148, -268, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_1UP, -2229, 68, -37, 0, 0, 0, 0x00000000, bhv1Up),
		...
		OBJECT(MODEL_NONE, 6460, 2142, 819, 0, 90, 0, 0x00000000, bhvInfiniteFlamethrower),
		OBJECT(MODEL_NONE, 7203, 2142, -205, 0, 0, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, 6719, 2142, -706, 0, 0, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_HEAVE_HO, 8419, 2134, -942, 0, 0, 0, 0x00000000, bhvHeaveHo),
	...
	AREA(2, wf_area_2),
		...
		SET_BACKGROUND_MUSIC(0x00, SEQ_BOUNCE_BOUNCE),
		TERRAIN_TYPE(TERRAIN_GRASS),
		/* Fast64 begin persistent block [area commands] */
		/* Fast64 end persistent block [area commands] */
	END_AREA(),
	...
	AREA(4, wf_area_4),
		...
		OBJECT(MODEL_NONE, 9844, 8204, 278, 0, 0, 0, (6 << 16), bhvChallengeDone),
	...
	AREA(9, wf_area_9),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_CASTLE, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_WF, 0x09, 0x07, WARP_NO_CHECKPOINT),
		INSTANT_WARP(0x00, 0x01, -8734, -386, 0),
		WARP_NODE(0x07, LEVEL_WF, 0x08, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x08, LEVEL_WF, 0x01, 0x08, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_1UP, 7983, 2212, -37, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_1UP, 7187, 2212, -37, 0, 0, 0, 0x00000000, bhv1Up),
		...
		OBJECT(MODEL_1UP, 3388, 70, -51, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_1UP, 5671, 295, -8, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_HEART, 7702, 713, 20, 0, 0, 0, (0x08 << 16), bhvRecoveryHeart),
		...
		OBJECT(MODEL_NONE, 7931, 2393, -632, 0, 0, 0, 0x00000000, bhvQuicksandTransporter),
		OBJECT(MODEL_NONE, 7310, 805, 18, 0, 0, 0, (0 << 16), bhvChallengeDone),
		OBJECT(MODEL_NONE, 7701, 833, 26, 0, 90, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 90, 7701, 833, 26),
		OBJECT(MODEL_NONE, 7312, 753, 1, 0, 0, 0, (0x07 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 7703, 713, 19, 0, 0, 0, (0x08 << 16), bhvDeathWarp),

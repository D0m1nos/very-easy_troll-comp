...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		INSTANT_WARP(0x00, 0x01, -5576, -386, 0),
		...
		OBJECT(MODEL_YELLOW_COIN, 912, 68, -26, 0, 90, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_STAR, 4609, 1110, -15, 0, 0, 0, (0 << 24), bhvStar),
		OBJECT(MODEL_EXCLAMATION_BOX, 2727, 313, 21, 0, 0, 0, (4 << 16), bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, 2883, 721, 23, 0, 0, 0, (4 << 16), bhvExclamationBox),
		OBJECT(MODEL_YELLOW_COIN, 1012, 68, -26, 0, 90, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 1112, 68, -26, 0, 90, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 1212, 68, -26, 0, 90, 0, 0x00000000, bhvEvilYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 1312, 68, -26, 0, 90, 0, 0x00000000, bhvYellowCoin),

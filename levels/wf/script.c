...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 3367, 229, 21, 0, 0, 0, (4 << 16), bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, 3610, 768, 23, 0, 0, 0, (5 << 16), bhvExclamationBox),
		OBJECT(MODEL_YELLOW_COIN, 1167, 68, -26, 0, 90, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_CHUCKYA, 5127, 2172, -496, 0, 0, 0, 0x00000000, bhvChuckya),
		...
		OBJECT(MODEL_NONE, 3980, 2208, 458, 0, -180, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, 4765, 2208, 286, 0, -180, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, 4370, 2208, -504, 0, 0, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, 4669, 2367, -37, 0, 0, 0, 0x00000000, bhvQuicksandTransporter),
		OBJECT(MODEL_1UP, 5257, 2278, -37, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_CHUCKYA, 5519, 2172, -683, 0, 0, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_AMP, 5652, 2214, -368, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 5823, 2214, -226, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 6018, 2214, -50, 0, 0, 0, 0x00000000, bhvHomingAmp),

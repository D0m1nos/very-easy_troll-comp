...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_AMP, 3958, 2148, -50, 0, 0, 0, 0x00000000, bhvHomingAmp),
		OBJECT(MODEL_NONE, 4830, 805, 18, 0, 0, 0, (0 << 16), bhvChallengeDone),
		OBJECT(MODEL_NONE, 6073, 2289, -42, 0, 90, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 90, 6073, 2289, -42),

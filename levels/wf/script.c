...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		INSTANT_WARP(0x00, 0x02, -2577, -29, -6161),
		OBJECT(MODEL_NONE, 13, 109, -6, 0, 0, 0, 0x00000000, bhvChallengeArena),
		OBJECT(MODEL_BITS_WARP_PIPE, 1885, 25, -551, 0, 0, 0, 0x00000000, bhvWarpPipe),
		OBJECT(MODEL_BITS_WARP_PIPE, 1885, 27, -40, 0, 0, 0, 0x00000000, bhvWarpPipe),
		OBJECT(MODEL_BITS_WARP_PIPE, 1885, 22, 472, 0, 0, 0, 0x00000000, bhvWarpPipe),

...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_YELLOW_COIN, 912, 68, -37, 0, 90, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_STAR, 4609, 1110, -15, 0, 0, 0, (0 << 24), bhvStar),
		OBJECT(MODEL_EXCLAMATION_BOX, 2727, 436, 21, 0, 0, 0, (15 << 16), bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, 2727, 436, 197, 0, 0, 0, (15 << 16), bhvExclamationBox),
		OBJECT(MODEL_YELLOW_COIN, 1012, 68, -37, 0, 90, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_EXCLAMATION_BOX, 2727, 436, -174, 0, 0, 0, (15 << 16), bhvExclamationBox),

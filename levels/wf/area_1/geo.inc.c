...
const GeoLayout wf_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 4333, 2140, -37, wf_dl_Cube_003_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 28, 17, -37, 0, 10, 0, wf_dl_Cylinder_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 5337, 634, -7, wf_dl_Cylinder_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 5337, 694, -7, wf_dl_Cylinder_002_mesh_layer_1),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 3635, 2197, -55, wf_dl_Plane_002_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};

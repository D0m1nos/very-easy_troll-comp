...
enum oActionsQuicksandTransporter {
    QUICKSAND_TRANSPORTER_NULL,
    QUICKSAND_TRANSPORTER_PUSH_BACK,
    QUICKSAND_TRANSPORTER_PUSH_DOWN,
    QUICKSAND_TRANSPORTER_END
};

enum oActionsMetalBox {
    METAL_BOX_NULL,

...
const BehaviorScript bhvActuallyRotatingPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_LONG(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_DONT_CALC_COLL_DIST)),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_actually_rotating_platform_loop),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
...
const BehaviorScript bhvThwomp3[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(thwomp_seg5_collision_0500B92C),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    DROP_TO_FLOOR(),
    ...
    ADD_FLOAT(oPosX, -100),
    ADD_FLOAT(oHomeY, -10),
    SET_FLOAT(oMoveAnglePitch, 8192),
    SCALE(/*Unused*/ 0, /*Field*/ 140),
    SET_FLOAT(oDrawingDistance, 4000),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
...
const BehaviorScript bhvFlameGravity[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_HOME(),
    ...
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, INT_STATUS_NONE),
        CALL_NATIVE(bhv_flame_gravity_loop),
        ANIMATE_TEXTURE(oAnimState, 2),
    END_LOOP(),
};
...
const BehaviorScript bhvInfiniteFlamethrower[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_infinite_flamethrower_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvInfiniteFlamethrowerFlame[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INTERACT_TYPE(INTERACT_FLAME),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 50, /*Height*/ 25, /*Downwards offset*/ 25),
    ...
    CALL_NATIVE(bhv_init_room),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_infinite_flamethrower_flame_loop),
        ADD_INT(oAnimState, 1),
    END_LOOP(),
};
...
const BehaviorScript bhvMessagePanel[] = {
    ...
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(load_object_collision_model),
        // CALL_NATIVE(bhv_font_test),
        SET_INT(oInteractStatus, INT_STATUS_NONE),
    END_LOOP(),
};

const BehaviorScript bhvMessagePanelSpawnPipe[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(wooden_signpost_seg3_collision_0302DD80),
    SET_FLOAT(oCollisionDistance, 150),
    ...
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 80),
    SET_INT(oWoodenPostTotalMarioAngle, 0),
    CALL_NATIVE(bhv_check_signs_init),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(load_object_collision_model),
        CALL_NATIVE(bhv_check_signs_loop),
        SET_INT(oInteractStatus, INT_STATUS_NONE),
    END_LOOP(),
};
...
const BehaviorScript bhvStarBoss[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    CALL_NATIVE(bhv_init_room),
    CALL_NATIVE(bhv_collect_star_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_collect_star_boss_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvChallengeArena[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BILLBOARD(),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 1000, /*Height*/ 1000, /*Downwards offset*/ 0),
    SET_FLOAT(oGraphYOffset, 30),
...
const BehaviorScript bhvThwompMessagePanel[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(wooden_signpost_seg3_collision_0302DD80),
    SET_FLOAT(oCollisionDistance, 150),
    ...
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(load_object_collision_model),
        CALL_NATIVE(bhv_message_panel_interaction),
        // SET_INT(oInteractStatus, INT_STATUS_NONE),
    END_LOOP(),
};
